...
public class CompanyDaoImplementation implements CompanyDao {
	...
	@Override
	public Company validateCompany(String em1, String pass1) {
		
		String jpql = "select c from Company c where c.email=:em and c.password=:pa";	
		Company c= null;
		try
		{
	...
	public String registerCompany(Company company) {
		System.out.println("in comp impl");
...
//	}
	...
	@Override
	public ArrayList<PostedJob> getPastJobs(int id) {
