...
public class AdminDAOImpl implements AdminDAO
{
	...
	{	
		String jpql="SELECT s from Student s where Cast(s.sscpercent as float)>= :sscmarks and  (Cast(s.hscpercent as float)>= :hscmarks or Cast(s.diplomapercent as float)>= :diplomamarks) and Cast(s.gradpercent as float)>= :gradmarks and s.placed!=true";
